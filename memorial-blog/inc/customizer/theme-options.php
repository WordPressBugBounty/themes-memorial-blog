...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'memorial-blog' ),
	'priority'   => 100,
...
$wp_customize->add_section('section_sidebar', array(    
	'title'       => __('Sidebar Options', 'memorial-blog'),
...
$wp_customize->add_setting('blog_sidebar', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'memorial_blog_sanitize_select',
	'transport'         => 'refresh',
	)
);
...
$wp_customize->add_control('blog_sidebar', 
	array(		
	'label' 	=> __('Blog Sidebar', 'memorial-blog'),
	'section' 	=> 'section_sidebar',
	'settings'  => 'blog_sidebar',
	'type' 		=> 'radio',
	'choices' 	=> array(		
		'left-sidebar' 	=> __( 'Left Sidebar', 'memorial-blog'),						
		'right-sidebar' => __( 'Right Sidebar', 'memorial-blog'),	
		'no-sidebar' 	=> __( 'No Sidebar', 'memorial-blog'),	
		),	
	)
);
...
$wp_customize->add_control('single_post_sidebar', 
	array(		
	'label' 	=> __('Single Post Sidebar', 'memorial-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('archive_sidebar', 
	array(		
	'label' 	=> __('Archive Sidebar', 'memorial-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_control('page_sidebar', 
	array(		
	'label' 	=> __('Page Sidebar', 'memorial-blog'),
	'section' 	=> 'section_sidebar',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'memorial-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'excerpt_length', array(
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'memorial_blog_sanitize_number_range',
	'transport'         => 'refresh',
) );

$wp_customize->add_control( 'excerpt_length', array(
	'label'       => __( 'Excerpt Length', 'memorial-blog' ),
	'description' => __( 'Note: Min 5 & Max 100.', 'memorial-blog' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Text', 'memorial-blog'),
	'panel'       => 'theme_option_panel'    
	)
);

$wp_customize->add_setting( 'read_more_label', array(
	'default'           => esc_html__('Read More', 'memorial-blog'),
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
...
$wp_customize->add_control( 'read_more_label', array(
	'label'       => __( 'Read More Label', 'memorial-blog' ),
